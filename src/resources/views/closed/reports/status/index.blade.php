...
@section('title', 'Охват дополнительным образованием по статусам')
@section('content')
    <h1>Охват дополнительным образованием по статусам</h1>
    <form name="fetch" method="post" action="/report/status/export">
        ...
        <input type="hidden" id="dynamic-fetch" value="/report/status/fetch">
        <div class="form-group">
